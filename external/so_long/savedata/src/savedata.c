...
/*   Updated: 2023/12/19 19:28:01 by lchiva           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	printstat(t_settings *sets)
{
	printf("%u %u %llu %llu %llu \n", sets->level, sets->prestige, sets->time_played, sets->total_steps, sets->total_steps);
}
